  ...
  <div class="card" role="main">
    ...
    <div class="characters" aria-label="characters">
      <div class="char">
        ...
        <div style="display:none;font-size:48px" aria-hidden="true">🦖</div>
      ...
      <div class="char">
        ...
        <div style="display:none;font-size:48px" aria-hidden="true">🕷️</div>
  ...
  <script>
    ...
    function updateCountdown() {
      ...
      if(diff > 0){
        ...
        countdownEl.textContent = `Birthday in ${days}d ${hours}h ${mins}m ${secs}s 🎉`;
      } else {
